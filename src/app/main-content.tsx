            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="inline-flex h-9 items-center justify-center rounded-lg bg-white/60 border border-neutral-200/60 p-0.5 shadow-sm">
                    <button
                      onClick={() => setActiveView("preview")}
                      className={cn(
                        "inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center rounded-md border border-transparent px-4 py-1.5 text-sm font-medium whitespace-nowrap transition-all",
                        activeView === "preview"
